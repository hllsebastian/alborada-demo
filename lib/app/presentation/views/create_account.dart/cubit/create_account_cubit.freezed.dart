...
mixin _$CreateAccountState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(AlboradaUser user) success,
    required TResult Function(String user) error,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(AlboradaUser user)? success,
    TResult? Function(String user)? error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$SuccessImpl implements _Success {
  ...
  @override
  String toString() {
    return 'CreateAccountState.success(user: $user)';
  }
...
abstract class _Success implements CreateAccountState {
  const factory _Success(final AlboradaUser user) = _$SuccessImpl;
...
class _$ErrorImpl implements _Error {
  ...
  @override
  String toString() {
    return 'CreateAccountState.error(user: $user)';
  }
...
abstract class _Error implements CreateAccountState {
  const factory _Error(final String user) = _$ErrorImpl;
